...
urlpatterns = [
    ...
    path('home', auth_views.LogoutView.as_view(template_name='covidcombatapp/home.html'), name='logout'),
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='covidcombatapp/password_reset.html'), name='password_reset'),
    path('password-reset/done', auth_views.PasswordResetDoneView.as_view(template_name='covidcombatapp/password_reset_done.html'), name='password_reset_done'),
